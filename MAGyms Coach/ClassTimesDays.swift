//
//  ClassTimesDays.swift
//  MAGyms Coach
//
//  Created by Denniston Sutherland on 09/08/2017.
...
class DaysHourMinute: Object {
//    class func getData() -> [DaysHourMinute] {
//        var data = [DaysHourMinute]()
    var dayName = ["Sun", "Mon", "Te", "Wed", "Thur", "Fri", "Sat"]
